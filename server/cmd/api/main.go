...
import (
	...
	"github.com/xrlnewman/feeflow-admin/server/internal/platform/database"
	"github.com/xrlnewman/feeflow-admin/server/internal/platform/store"
	"github.com/xrlnewman/feeflow-admin/server/internal/transport/httpapi"
)
...
func main() {
	...
	defer stop()
	go func() {
		slog.Info("FeeFlow API 已启动", "addr", cfg.Addr)
