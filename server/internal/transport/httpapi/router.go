...
import (
	...
	"github.com/xrlnewman/feeflow-admin/server/internal/app/dispatch"
	"github.com/xrlnewman/feeflow-admin/server/internal/app/inventory"
	orderapp "github.com/xrlnewman/feeflow-admin/server/internal/app/order"
	"github.com/xrlnewman/feeflow-admin/server/internal/config"
	"github.com/xrlnewman/feeflow-admin/server/internal/domain"
	platformauth "github.com/xrlnewman/feeflow-admin/server/internal/platform/auth"
	"github.com/xrlnewman/feeflow-admin/server/internal/platform/cache"
...
func seed(st *store.MemoryStore) {
	...
	st.SeedUser(store.User{ID: "user-demo", Phone: "13800000000", PasswordHash: string(hash), Name: "演示申请人", Role: "customer"})
